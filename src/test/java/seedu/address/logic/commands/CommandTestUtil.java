...
public class CommandTestUtil {
    ...
    public static final String VALID_INTERSHIPSLOT_AMY = "02-12-2030 13:00";
    public static final String VALID_INTERSHIPSLOT_BOB = "02-12-2035 13:00";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final String VALID_JOBTITLE_AMY = "Intern";
    public static final String VALID_JOBTITLE_BOB = "Janitor";
    ...
    public static final String INTERVIEW_DESC_AMY = " " + PREFIX_INTERVIEW_SLOT + VALID_INTERSHIPSLOT_AMY;
    public static final String INTERVIEW_DESC_BOB = " " + PREFIX_INTERVIEW_SLOT + VALID_INTERSHIPSLOT_BOB;
    ...
    public static final String INVALID_JOBTITLE_DESC =
            " " + PREFIX_JOBTITLE + "J@v@ developer"; // '@' not allowed in job title
