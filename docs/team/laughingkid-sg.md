...
* **Documentation**:
  * User Guide: 
    * Updated documentation for list function to include sorting function and interview date field. 

  * Developer Guide:
    * Updated documentation for the architecture section
    * Added documentation on the implementation of the sorting feature and interview date field.
...
* **Tools**:
  ...
  * Used imgbot to optimise images in the repo. [#59](https://github.com/AY2122S2-CS2103T-T11-3/tp/pull/59)
